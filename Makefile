...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/icy37785/clash/constant.Version=$(VERSION)" \
		-X "github.com/icy37785/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
